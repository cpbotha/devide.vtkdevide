...
REM devenv vtkdevide.sln /project ALL_BUILD /projectconfig "Debug|Win32" /build Debug
devenv vtkdevide.sln /project ALL_BUILD /projectconfig "RelWithDebInfo|Win32" /build RelWithDebInfo
