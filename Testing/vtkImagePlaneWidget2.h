...
=========================================================================*/
// .NAME vtkImagePlaneWidget2 - 3D widget for reslicing image data
// .SECTION Description
...
// vtkImagePlaneWidget2, like any 3D widget, will work with the current
// interactor style. That is, if vtkImagePlaneWidget2 does not handle an
...
// vtkImagePlaneWidget2 will terminate the processing of the event that it
// handles.
//
...
// "interactor") is pressed, the vtkImagePlaneWidget2 will appear. (See
...
//
// The vtkImagePlaneWidget2 has several methods that can be used in
...
#ifndef __vtkImagePlaneWidget2_h
...
public:
  ...
  static vtkImagePlaneWidget2 *New();

  vtkTypeRevisionMacro(vtkImagePlaneWidget2,vtkPolyDataSourceWidget);
...
//ETX
  ...
  vtkDataSetMapper    *VoxelMapper;
  vtkActor            *VoxelActor;
  void                 GenerateVoxel();

private:
  vtkImagePlaneWidget2(const vtkImagePlaneWidget2&);  //Not implemented
  void operator=(const vtkImagePlaneWidget2&);  //Not implemented
};
