...
const GMOD_MAX_SECTIONS=32;
const GMOD_UNUSED_VERTEX=65535;
const G1_SECTION_MODEL_QUADS=18;
const G1_SECTION_MODEL_TEXTURE_NAMES=19;
const G1_SECTION_MODEL_VERT_ANIMATION=20;
