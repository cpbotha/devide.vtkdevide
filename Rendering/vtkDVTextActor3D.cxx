/*=========================================================================
  ...
  Module:    $RCSfile: vtkDVTextActor3D.cxx,v $
...
vtkCxxRevisionMacro(vtkDVTextActor3D, "$Revision: 1.6 $");
vtkStandardNewMacro(vtkDVTextActor3D);

vtkCxxSetObjectMacro(vtkDVTextActor3D, TextProperty, vtkTextProperty);

// ----------------------------------------------------------------------------
vtkDVTextActor3D::vtkDVTextActor3D()
{
  this->Input        = NULL;
...
// --------------------------------------------------------------------------
void vtkDVTextActor3D::ShallowCopy(vtkProp *prop)
{
  vtkDVTextActor3D *a = vtkDVTextActor3D::SafeDownCast(prop);
  if (a != NULL)
    {
...
double* vtkDVTextActor3D::GetBounds()
{
  if (this->ImageActor)
    {
...
// --------------------------------------------------------------------------
void vtkDVTextActor3D::ReleaseGraphicsResources(vtkWindow *win)
{
  if (this->ImageActor)
    {
...
// --------------------------------------------------------------------------
int vtkDVTextActor3D::RenderOverlay(vtkViewport *viewport)
{
...
// ----------------------------------------------------------------------------
int vtkDVTextActor3D::RenderTranslucentPolygonalGeometry(vtkViewport *viewport)
{
  int rendered_something = 0;
...
int vtkDVTextActor3D::HasTranslucentPolygonalGeometry()
{
  int result = 0;
...
// --------------------------------------------------------------------------
int vtkDVTextActor3D::RenderOpaqueGeometry(vtkViewport *viewport)
{
  int rendered_something = 0;
...
// --------------------------------------------------------------------------
int vtkDVTextActor3D::UpdateImageActor()
{
  // Need text prop
...
// --------------------------------------------------------------------------
void vtkDVTextActor3D::PrintSelf(ostream& os, vtkIndent indent)
{
