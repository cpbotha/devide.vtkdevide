/*=========================================================================
  ...
  Module:    $RCSfile: vtkDVTextActor3D.h,v $
...
=========================================================================*/
// .NAME vtkDVTextActor3D - An actor that displays text.
// .SECTION Description
...
//
// This version has been modified by Charl Botha for use in DeVIDE:
// - you can get the bounds of the generated image BEFORE the first
//   render.  This can be used to size containing shapes for example.
//
// .SECTION Warning
...
#ifndef __vtkDVTextActor3D_h
#define __vtkDVTextActor3D_h
...
class VTK_RENDERING_EXPORT vtkDVTextActor3D : public vtkProp3D
{
public:
  static vtkDVTextActor3D *New();
  vtkTypeRevisionMacro(vtkDVTextActor3D,vtkProp3D);
...
private:
  vtkDVTextActor3D(const vtkDVTextActor3D&);  // Not implemented.
  void operator=(const vtkDVTextActor3D&);  // Not implemented.
};
