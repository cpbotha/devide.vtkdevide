...
IF (USE_VTK_FILE)
  ...
  SET(VTKCPBOTHA_BUILD_SHARED_LIBS ${BUILD_SHARED_LIBS} CACHE INTERNAL 
      "Is this VTKCPBOTHA built with shared libraries.")
      
  #
  # Output path(s)
  #

  SET (LIBRARY_OUTPUT_PATH ${VTKCPBOTHA_BINARY_DIR}/bin/ CACHE PATH
       "Single output directory for building all libraries.")

  SET (EXECUTABLE_OUTPUT_PATH ${VTKCPBOTHA_BINARY_DIR}/bin/ CACHE PATH 
...
IF (VTK_WRAP_PYTHON)
  ...
  OPTION(VTKCPBOTHA_WRAP_PYTHON 
         "Wrap classes into the Python interpreted language." 
         ON)
         
  IF (VTKCPBOTHA_WRAP_PYTHON)
    ...
    ELSE (NOT VTK_WRAP_PYTHON_EXE)
      ...
      FIND_FILE(VTK_WRAP_HINTS hints ${VTKCPBOTHA_SOURCE_DIR}/Wrapping )
  ...
  ENDIF (VTKCPBOTHA_WRAP_PYTHON)

ELSE (VTK_WRAP_PYTHON)

  IF (VTKCPBOTHA_WRAP_PYTHON)
    MESSAGE("Warning. VTKCPBOTHA_WRAP_PYTHON is ON but the VTK version you have chosen has not support for Python (VTK_WRAP_PYTHON is OFF). Please set VTKCPBOTHA_WRAP_PYTHON to OFF.")
    SET (VTKCPBOTHA_WRAP_PYTHON_OFF)
  ENDIF (VTKCPBOTHA_WRAP_PYTHON)
