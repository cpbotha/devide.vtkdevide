...
FIND_PATH(GDCM_INCLUDE_PATH gdcm.h
DOC "The include directory containing gdcm.h"
)

FIND_PATH(GDCM_LIB_PATH itkgdcm.lib
DOC "The directory containing itkgdcm.lib / libitkgdcm.so."
)

IF (GDCM_INCLUDE_PATH)
  IF (GDCM_LIB_PATH)
    SET (HAS_GDCM 1 CACHE INTERNAL "GDCM available.")
  ENDIF (GDCM_LIB_PATH)
ENDIF (GDCM_INCLUDE_PATH)
