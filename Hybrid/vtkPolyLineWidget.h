// .NAME vtkPolyLineWidget - 3D widget for manipulating a spline
// .SECTION Description
...
// A nice feature of the object is that the vtkPolyLineWidget, like any 3D
// widget, will work with the current interactor style. That is, if
// vtkPolyLineWidget does not handle an event, then all other registered
// observers (including the interactor style) have an opportunity to process
// the event. Otherwise, the vtkPolyLineWidget will terminate the processing of
...
// vtkPolyLineWidget will appear. (See superclass documentation for information
...
//
// The vtkPolyLineWidget has several methods that can be used in conjunction with
...
#ifndef __vtkPolyLineWidget_h
#define __vtkPolyLineWidget_h
...
class VTK_DEVIDE_HYBRID_EXPORT vtkPolyLineWidget : public vtk3DWidget
{
public:
  // Description:
  ...
  vtkTypeRevisionMacro(vtkPolyLineWidget,vtk3DWidget);
