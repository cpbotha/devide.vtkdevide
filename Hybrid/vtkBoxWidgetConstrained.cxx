...
{
  this->State = vtkBoxWidgetConstrained::Start;
  this->EventCallbackCommand->SetCallback(vtkBoxWidgetConstrained::ProcessEvents);
...
void vtkBoxWidgetConstrained::SetEnabled(int enabling)
{
  if ( ! this->Interactor )
    {
...
void vtkBoxWidgetConstrained::ProcessEvents(vtkObject* vtkNotUsed(object), 
                                 unsigned long event,
                                 void* clientdata, 
                                 void* vtkNotUsed(calldata))
{
  vtkBoxWidgetConstrained* self = reinterpret_cast<vtkBoxWidgetConstrained *>( clientdata );
...
void vtkBoxWidgetConstrained::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkBoxWidgetConstrained::PositionHandles()
{
...
void vtkBoxWidgetConstrained::SizeHandles()
{
...
int vtkBoxWidgetConstrained::HighlightHandle(vtkProp *prop)
{
...
void vtkBoxWidgetConstrained::HighlightFace(int cellId)
{
  if ( cellId >= 0 )
    {
    vtkIdType npts;
...
void vtkBoxWidgetConstrained::HighlightOutline(int highlight)
{
  if ( highlight )
    {
...
void vtkBoxWidgetConstrained::OnLeftButtonDown()
{
  ...
  if ( ren != this->CurrentRenderer )
    {
    this->State = vtkBoxWidgetConstrained::Outside;
    return;
    }
  ...
  if ( path != NULL )
    {
    this->State = vtkBoxWidgetConstrained::Moving;
    this->HighlightFace(
...
void vtkBoxWidgetConstrained::OnLeftButtonUp()
{
  if ( this->State == vtkBoxWidgetConstrained::Outside ||
       this->State == vtkBoxWidgetConstrained::Start )
    {
    return;
    }
...
void vtkBoxWidgetConstrained::OnMiddleButtonDown()
{
  int X = this->Interactor->GetEventPosition()[0];
  int Y = this->Interactor->GetEventPosition()[1];
...
void vtkBoxWidgetConstrained::OnMiddleButtonUp()
{
  if ( this->State == vtkBoxWidgetConstrained::Outside ||
       this->State == vtkBoxWidgetConstrained::Start )
    {
...
void vtkBoxWidgetConstrained::OnRightButtonDown()
{
  int X = this->Interactor->GetEventPosition()[0];
  int Y = this->Interactor->GetEventPosition()[1];
  ...
  if ( path != NULL )
    {
    this->State = vtkBoxWidgetConstrained::Scaling;
    this->HighlightOutline(1);
    this->HandlePicker->GetPickPosition(this->LastPickPosition);
    this->ValidPick = 1;
    }
...
void vtkBoxWidgetConstrained::OnRightButtonUp()
{
  if ( this->State == vtkBoxWidgetConstrained::Outside )
    {
    return;
...
void vtkBoxWidgetConstrained::OnMouseMove()
{
  ...
  // Process the motion
  if ( this->State == vtkBoxWidgetConstrained::Moving )
    {
    // Okay to process
    if ( this->CurrentHandle )
      {
  ...
  else if ( this->ScalingEnabled && this->State == vtkBoxWidgetConstrained::Scaling )
    {
...
void vtkBoxWidgetConstrained::MoveFace(double *p1, double *p2,
                            double *h1, double *h2,
                            double *x1, double *x2,
                            double *x3, double *x4,
                            double *x5)
...
void vtkBoxWidgetConstrained::MovePlusXFace(double *p1, double *p2)
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
...
void vtkBoxWidgetConstrained::MoveMinusXFace(double *p1, double *p2)
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
...
void vtkBoxWidgetConstrained::MovePlusYFace(double *p1, double *p2)
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
...
void vtkBoxWidgetConstrained::MoveMinusYFace(double *p1, double *p2)
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
...
void vtkBoxWidgetConstrained::MovePlusZFace(double *p1, double *p2)
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
...
void vtkBoxWidgetConstrained::MoveMinusZFace(double *p1, double *p2)
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
...
void vtkBoxWidgetConstrained::Scale(double* vtkNotUsed(p1), double* vtkNotUsed(p2), 
...
void vtkBoxWidgetConstrained::ComputeNormals()
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
  double *p0 = pts;
  double *px = pts + 3*1;
...
void vtkBoxWidgetConstrained::GetPlanes(vtkPlanes *planes)
{
  if ( ! planes )
    {
    return;
...
void vtkBoxWidgetConstrained::CreateDefaultProperties()
{
  // Handle properties
...
void vtkBoxWidgetConstrained::PlaceWidget(float bds[6])
{
  int i;
...
void vtkBoxWidgetConstrained::GetTransform(vtkTransform *t)
{
  double *pts = ((vtkDoubleArray *)this->Points->GetData())->GetPointer(0);
  double *p0 = pts;
  double *p1 = pts + 3*1;
...
void vtkBoxWidgetConstrained::GetPolyData(vtkPolyData *pd)
{
  pd->SetPoints(this->HexPolyData->GetPoints());
  pd->SetPolys(this->HexPolyData->GetPolys());
}

void vtkBoxWidgetConstrained::GenerateOutline()
{
